    ...
    while not event.getKeys():
        ...
        if order == 0:
            if axis == 0:
                ...
                if mouse.getPos()[0] != prev_pos[0] and mouse.getPressed()[0] == True:
                    crosshair.setWithGain(mouse.getPos(),gain,DISTANCE_FROM_CENTRE)
                    prev_pos[0] = mouse.getPos()[0]
                else:
                    crosshair.setWithGain((crosshair.get(DISTANCE_FROM_CENTRE)[0] + distX,crosshair.get(DISTANCE_FROM_CENTRE)[1]) , gain, DISTANCE_FROM_CENTRE)
                    mouse.setPos(newPos = crosshair.get(DISTANCE_FROM_CENTRE))
            else:
                if mouse.getPos()[0] != prev_pos[0] and mouse.getPos()[1] != prev_pos[1] and mouse.getPressed()[0] == True:
                    crosshair.setWithGain(mouse.getPos(),gain,DISTANCE_FROM_CENTRE)
                    prev_pos = mouse.getPos()
                else:
                    crosshair.setWithGain((crosshair.get(DISTANCE_FROM_CENTRE)[0] + distX,crosshair.get(DISTANCE_FROM_CENTRE)[1] + distY) , gain, DISTANCE_FROM_CENTRE)
                    mouse.setPos(newPos = crosshair.get(DISTANCE_FROM_CENTRE))
        ...
        if order == 1:
            ...
            if axis == 0:
                pos = [crosshair.get(DISTANCE_FROM_CENTRE)[0] + speedX + distX,0]
            else:
                pos = [crosshair.get(DISTANCE_FROM_CENTRE)[0] + speedX + distX, crosshair.get(DISTANCE_FROM_CENTRE)[1] + speedY + distY]
