...
def easy_many(something):
    ...
    def main():
        ...
        results_file = open('results_easy_many.txt',"a")
...
def hard_few(something):
    ...
    def main():
        ...
        results_file = open('results_hard_many.txt',"a")
        number_of_objects = 10
        dependantText = '∅'
        independantText = 'O'
        dependantSize = 1
...
if __name__ == "__main__":
    # Get user input to decide which function to call
    something = input("""Select: \nEasy few: ef\nEasy many: em\nHard few:
                      hf\nHard many: hm""").lower()
