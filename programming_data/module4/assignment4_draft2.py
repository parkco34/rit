...
(assumed to be approximately √{steps} ≈ {sqrt(steps)} elements, which fits with the size of the randomly generated array: {len(self.data)})"""))
        print("==================================================================================================")
        return self.data
    ...
    def bubble_sort(self):
        ...
        print("==================================================================================================")
        print(f"Manual Bubble Sort clocked in at: {end - start} and took {steps} steps.")
        print(dedent(f"""Based on the number of steps and time it took, the complexity is likely near O(n^2),
which is approximately proportional to the square of the number of elements
(assumed to be approximately √{steps} ≈ {sqrt(steps)} elements, which fits with the size of the randomly generated array: {len(self.data)})"""))
        print("==================================================================================================")
